...
const features = [
  {
    ...
    icon: Upload,
    additionalText:
      "Drag and drop files or select from your computer. It's that simple!",
  },
  {
    title: "Organized Storage",
    description: "Keep your documents neatly organized and accessible.",
    icon: FolderOpen,
    additionalText:
      "Find what you need instantly with our intelligent categorization.",
  },
  {
    title: "Deadline Reminders",
    description: "Receive SMS reminders for important filing deadlines.",
    icon: Bell,
    additionalText:
      "Stay ahead of the game with alerts sent directly to your phone.",
  },
  {
    title: "Document Sharing",
    description:
      "Seamlessly share specific documents via a secure link with employers, inspectors, insurance agents, and 3rd parties.",
    icon: Share2,
    additionalText: "Securely share with a click, no more email attachments.",
  },
  {
    title: "Customizable Folders",
    description:
      'Organize documents by categories like "Insurance," "Permits," "Vehicle Registration," and more.',
    icon: Folder,
    additionalText: "Personalize your workspace to suit your business needs.",
  },
  {
    title: "Compliance Tracking",
    description:
    ...
    icon: ShieldCheck,
    additionalText:
      "Automatic updates on regulations so you never miss a beat.",
  },
];
          ...
          >
            <Card className="h-full flex flex-col">
              ...
              <CardContent className="flex-grow flex flex-col justify-between">
                ...
                <p className="text-sm text-gray-500 bg-gray-100 p-3 rounded-lg mt-auto">
